...
static const Key keys[] = {
	...
	{ MODKEY2, 			XK_F6,	   spawn, 	   SHCMD("/usr/bin/xbacklight -dec 10; kill -45 $(cat ~/.cache/statusid)") },
	{ MODKEY2, 			XK_F7,	   spawn, 	   SHCMD("/usr/bin/xbacklight -inc 10; kill -45 $(cat ~/.cache/statusid)") },
